...
In order to add package to N725 OpenWrt, user has to build the one form source using cross-compilation approach. Then the compiled files has to be put to the directory appropriate directory location on the device.
